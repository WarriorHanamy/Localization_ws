...
void livox_pcl_cbk(const livox_ros_driver2::CustomMsg::ConstPtr &msg) 
{
    ...
    Eigen::Matrix3f R;
    R << 0.962890, -0.046370,       0.265881,
        0.051756,       0.998571,       -0.013283,
        -0.264885,  0.026551,       0.963914;

    for (const auto& pt : ptr->points) 
    {
        Eigen::Vector3d pl(pt.x, pt.y, pt.z);
        // Eigen::Vector3f pb =  R* pl;   // 只旋转，不平移
        // Eigen::Vector3d pb =  Lidar_wrt_Body_R* pl;   // 只旋转，不平移
...
int main(int argc, char** argv) 
{
    ...
    std::cout << "Lidar_wrt_Body_R_vec[0] : " << Lidar_wrt_Body_R_vec[0] << std::endl;
    std::cout << "Lidar_wrt_Body_R_vec[1] : " << Lidar_wrt_Body_R_vec[1] << std::endl;
    std::cout << "Lidar_wrt_Body_R_vec[2] : " << Lidar_wrt_Body_R_vec[2] << std::endl;
    std::cout << "Lidar_wrt_Body_R_vec[3] : " << Lidar_wrt_Body_R_vec[3] << std::endl;
    std::cout << "Lidar_wrt_Body_R_vec[4] : " << Lidar_wrt_Body_R_vec[4] << std::endl;
    std::cout << "Lidar_wrt_Body_R_vec[5] : " << Lidar_wrt_Body_R_vec[5] << std::endl;
    std::cout << "Lidar_wrt_Body_R_vec[6] : " << Lidar_wrt_Body_R_vec[6] << std::endl;
    std::cout << "Lidar_wrt_Body_R_vec[7] : " << Lidar_wrt_Body_R_vec[7] << std::endl;
